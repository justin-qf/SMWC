...
import com.vovance.securemywillcall.databinding.FragmentEditBinding
import com.vovance.securemywillcall.fragments.BaseFragment

class EditFragment : BaseFragment<FragmentEditBinding>(), View.OnClickListener {
    ...
    private fun initViews() {
        ...
        binding.toolbar.submitLayout.setOnClickListener {
            validation()
        }
    ...
    override fun onClick(view: View?) {
        ...
        if (id == binding.toolbar.ivBack.id) {
            HELPER.print("EditFragment","YES")
