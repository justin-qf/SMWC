...
import com.vovance.securemywillcall.databinding.ItemStickyDateBinding
import com.vovance.securemywillcall.databinding.StoreMatchesItemLayoutBinding
import com.vovance.securemywillcall.fragments.Home.OrdersType
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder.itemViewType) {
            ...
            Constant.IS_ITEM -> {
                ...
                holder.binding.orderNumber.text = model.order!!.orderNumber.toString().trim()
            }
        }
    }
